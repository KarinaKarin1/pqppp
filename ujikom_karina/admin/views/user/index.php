...
<body>
  ...
  <section class="jumbotron text-center" data-aos="zoom-in-right">
    <img src="http://localhost/ujikom_karina/public/asset/img/karin1.jpg" alt="" width="300" class="rounded-circle"/>
.    <h1 class="display-4"> Karinnnnnnn </h1>
    <p class="lead">siswaaaa \ smkn4 tasikmalaya</p>
  </section>
  ...
  <section id="about">
    ...
    <div class="row justify-content-center fs-5">
      <div class="col-sm-4" data-aos="flip-left" data-aos-duration="3000">
        <p>Hallo,aku Karina aku berasal dari kp.cibodas cita-citaku menjadi pengusaha</p>
      </div>
      <div class="col-sm-4" data-aos="flip-right"data-aos-duration="3000">
        <p>Aku sangat suka sekali Korea,dan bercita cita pergi ke korea</p>
      </div>
    </div>
  </section>
    ...
    <div class="row text-center"data-aos="zoom-in">
     ...
     data-aos-duration="1500"data-aos-delay="50">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <p class="card-text">Kegagalan adalah jalan menuju kesuksesan</p>
          </div>
        </div>
       </div>
